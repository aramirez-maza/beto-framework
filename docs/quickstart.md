...
**Gate G-3 (after Step 9):** You will see the `MANIFEST_PROYECTO` — the complete project manifest listing every authorized component, every TRACE_REGISTRY ID, and the full materialization plan. Approve to authorize code generation.
